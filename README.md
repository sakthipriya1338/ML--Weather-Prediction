...
random_state=42)
_, _, y_pm25_train, y_pm25_test = train_test_split(X, y_pm25, test_size=0.2, 
random_state=42)
_, _, y_energy_train, y_energy_test = train_test_split(X, y_energy, test_size=0.2, 
random_state=42)
...
## Output:
<img width="456" height="80" alt="image" src="https://github.com/user-attachments/assets/6b2bb1fe-9807-4fa7-9009-ebf1035632c5" />


## Result:

The Random Forest model was successfully implemented and used to predict temperature, PM2.5 level.
